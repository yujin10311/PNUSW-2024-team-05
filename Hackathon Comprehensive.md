### 1. 프로젝트 소개
#### 1.1. 개발배경 및 필요성
>  2022년 통계에 따르면 국내 우울증 환자 수가 100만 명을 넘어섰습니다. 그리고, 가장 큰 비중을 차지하는 <br>세대는 2030세대입니다. 이처럼 사회 전반에 영향을 미치는 우울증의 초기 상태를 우울감이라고 합니다.
>  
>  이 우울감을 잘 관리할 수 있다면 심각한 우울증에 걸리지 않습니다.<br>
>  하지만, 사회적으로 우울증 초기 상태부터 관리를 하는 사례는 잘 없습니다.
<br/>

#### 1.2. 개발목표 및 주요내용
 **개발목표**: 청년이 자신의 우울감을 파악하고 관리할 수 있도록 유도하는 앱을 만들자
 
 **주요내용:**
   1. 일상의 고민과 이야기를 함께하는 **챗봇**
   2. 우울감을 겪는 이들의 쇼츠형 **켜뮤니티**
   3. ai를 이용한 이용자 **아바타** 생성
<br/>
...
#### 1.3. 세부내용
  1. 챗봇
     ...
     - 당일 대화 바탕 감정 분석
     - 감정 기간별 통계
     - 당일 대화 바탕 일기형태 요약본 제공
  2. 쇼츠형 커뮤니티
     - 글 작성 및 공유
     - 좋아요 등 공감
     - 글 삭제 등 관리
  3. 아바타 꾸미기
     - 채팅 데이터를 기반 생성형 ai를 이용해 개별화된 이미지를 생산하고, 이를 아바타 메뉴에서 제공
  4. 우울자가검사
     - PHQ 설문조사 진행
<br/>

#### 1.4. 기존 서비스(상품) 대비 차별성
  - AI 챗봇상담과 사람 간의 커뮤니티의 연계(장단점 보안 가능)
  - 채팅 내용 바탕에 분석과 요약본 제공
  - 채팅 내용 바탕으로 유저 아바타 생성. 유저의 색깔을 보여줌.(재미 요소 가미)
<br/>
