...
1. 회원가입
    <p align="left"> 
    <img src="docs/readmeAssets/1.png" align="center" width="200"> 
    <img src="docs/readmeAssets/2.png" align="center" width="200"> 
    <img src="docs/readmeAssets/3.png" align="center" width="200">

    |라벨|이름|상세|
    |:---:|:----------------------------:|:---|
    | 1  | 로그인 정보입력             | - 로그인에 필요한 이메일과 비밀번호를 입력
    ...
    <br>
    <img src="docs/readmeAssets/4.png" align="center" width="200">
    <img src="docs/readmeAssets/5.png" align="center" width="200"> 
    <img src="docs/readmeAssets/6.png" align="center" width="200"> 
    ...
    <br>
    <img src="docs/readmeAssets/7.png" align="center" width="200"> 
    <img src="docs/readmeAssets/8.png" align="center" width="200"> 
    <img src="docs/readmeAssets/9.png" align="center" width="200"> 
    <img src="docs/readmeAssets/10.png" align="center" width="200"> 
    <img src="docs/readmeAssets/11.png" align="center" width="200"> 
    <img src="docs/readmeAssets/12.png" align="center" width="200"> 
    <img src="docs/readmeAssets/13.png" align="center" width="200"> 
    </p>


    |라벨|이름|상세|
    |:---:|:----------------------------:|:---|
    | 1  | 부산대학교 웹메일              | - 부산대 웹메일 형식인지 검증 <br/>- 중복되는 이메일인지 검증 |
    | 2  | 부산대학교 웹메일 인증 코드 전송| - 클릭 시 인증 코드 메일로 전송 |
    | 3  | 메일 인증 코드                 | - 인증 요청 버튼 클릭 후 활성화 <br/>- 유효시간 5분|
    | 4  | 메일 인증 코드 확인            | - 인증코드 검증 |
    | 5  | 닉네임                        | - 4 ~ 12자 영어, 숫자, '_' 가능 |
    | 6  | 단과대학 선택                  | -부산대학교 단과대학 리스트 보여주기 |
    | 7  | 학과 선택                     | - 단과대학 안의 학과 리스트 보여주기 |
    | 8  | 비밀번호                      | - 입력 시 텍스트 보이지 않도록 •로 표현해주기 <br/>- 6자 이상 20자 이하, 영어와 숫자 조합 필수 |
    | 9  | 비밀번호 확인                  | - 입력 시 텍스트 보이지 않도록 •로 표현해주기 <br/>- 비밀번호와 동일한 지 검증 |
    | 10 | 회원가입 완료                  | - 비어 있는 입력 칸이 없는지 검증 <br/>-메일 인증 완료했는지 확인 <br/>-조건을 만족하면 회원가입 성공|
    | 11 | 로그인                        | - 클릭 시 로그인 모달로 전환 |
