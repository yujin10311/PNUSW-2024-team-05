...
- 이유진
  > 체계적인 운영과 풍부한 관련 교육 덕분에 알찬 경험을 쌓을 수 있었습니다. 다양한 전공의 팀원과 만나 협업할 수 있어 팀원 모두에게 새로운 도전이었던 것 같습니다. 전반적인 개발에 함께하며 문제 해결 방식과 실제적인 구현 과정을 파악할 수 있었습니다. 향후 IT 서비스 기획자로서 진로를 준비하는 길에 큰 밑거름이 되리라 생각합니다.
<br/>
